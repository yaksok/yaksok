...
function_helper = []
pushing = False
for line in open(os.path.join(os.path.split(__file__)[0], 'bootbakyi.js')):
    if '____find_and_call_function' in line:
        pushing = True
    if pushing:
        function_helper.append(line)
    if pushing and line == '}\n':
        break
function_helper = ''.join(function_helper)
